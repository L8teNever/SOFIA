...
def _load_or_generate_vapid():
    ...
    # Auto-generate using cryptography (already installed via pywebpush)
    ...
    priv_pem = key.private_bytes(Encoding.PEM, PrivateFormat.TraditionalOpenSSL, NoEncryption()).decode()
