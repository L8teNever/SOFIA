const API = {
  ...
  notesBoards:      (scope)     => API.get('/notes/boards' + (scope ? `?scope=${scope}` : '')),
  createNotesBoard: (d)         => API.post('/notes/boards', d),
  notesBoard:       (id)        => API.get(`/notes/boards/${id}`),
  updateNotesBoard: (id, d)     => API.put(`/notes/boards/${id}`, d),
  deleteNotesBoard: (id)        => API.delete(`/notes/boards/${id}`),
